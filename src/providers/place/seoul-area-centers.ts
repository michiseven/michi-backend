...
const AREA_CENTERS: Readonly<Record<string, SeoulSearchArea>> = {
  ...
  신촌: { longitude: 126.9368, latitude: 37.5559, radiusMeters: 2_500 },
  ...
  안국: { longitude: 126.9854, latitude: 37.576, radiusMeters: 2_500 },
  서촌: { longitude: 126.9689, latitude: 37.5795, radiusMeters: 2_500 },
