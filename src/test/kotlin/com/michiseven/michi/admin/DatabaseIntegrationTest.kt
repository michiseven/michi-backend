...
class DatabaseIntegrationTest {
    ...
    fun setup() {
        try {
            ...
            println("Skipping Testcontainers if Docker daemon is not running: ${e.message}")
            return
        }
        ...
        setupDataSource.connection.use { conn ->
            conn.createStatement().use { stmt ->
                ...
                stmt.execute("""
                    ...
                    VALUES 
                    ('11111111-1111-1111-1111-111111111111', 'kto', 'kto-101', 'Gyeongbokgung Palace', '관광지', 'Seoul Jongno-gu Sejongno', 'Sajik-ro 161', ST_SetSRID(ST_MakePoint(126.9769, 37.5796), 4326)::geography, '{"source": "kto"}'::jsonb),
                    ('22222222-2222-2222-2222-222222222222', 'naver', 'nav-202', 'Bukchon Hanok Village', '관광지', 'Seoul Jongno-gu Gahoe-dong', 'Bukchon-ro', NULL, '{"source": "naver"}'::jsonb);
    ...
    @Test
    fun `queries places, evaluations, and summary successfully`() {
        if (!postgres.isRunning) return
        ...
        assertEquals(2, summary.places.total)
        assertEquals(1, summary.places.withoutLocation)
        ...
        assertEquals(2, places.totalItems)
